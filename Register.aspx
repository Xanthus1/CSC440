...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <form runat="server">
        <table>
            <tr><td>Name</td><td>
                <asp:TextBox ID="tb_name" runat="server" OnTextChanged="tb_TextChanged" AutoPostBack="true"></asp:TextBox>
                </td></tr>
            <tr><td>Email</td><td>
            ...
            <tr><td>Confirm Password</td><td>
                <asp:TextBox ID="tb_passwordconfirm" runat="server" OnTextChanged="tb_TextChanged" AutoPostBack="true"></asp:TextBox>
                </td></tr>
        </table>
        <br />
